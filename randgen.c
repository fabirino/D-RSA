/**
 * @file PRBG.h
 * @brief Generates a pseudo-random stream of bytes.
...
int main(int argc, char *argv[]) {
    ...
    // Generate the output
    uint8_t PRB[512]; // pseudo-random stream of bytes
    generate_bytes(bootstrap_seed, password, confusion_string, iteration_count, PRB);
